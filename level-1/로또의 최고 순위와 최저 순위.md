...
vector<int> solution(vector<int> lottos, vector<int> win_nums) {
    ...
    answer.push_back(7 - (zero_count + match_count));
    answer.push_back(7 - (match_count));
...
vector<int> solution(vector<int> lottos, vector<int> win_nums) {
    ...
    answer[0] = lotto_rank[count + zero_count];
    answer[1] = lotto_rank[count];
